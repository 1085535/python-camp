#tamagotchi proj
while True:
    print(f"----------------------------------------\n kflWELCOME TO THIS INTERACTIVE SIMULATION\n----------------------------------------")
    ...
    print("\n your pet's hunger is at",hunger,"your pet's happiness is at",happiness,"your pet has",health,"lives. your pet's sleep is at",sleep,"your pet's water is at",water,"your pet's cleanliness is at",cleanliness,"If your stats hit zero, you lose")
